...
func update_animation(index: int = 3, changeEquip: bool = true):#index 3 is ignored, index 0 means it is fist animation, 1 is sword, 2 is lance
	var idle_path
	var idle_weapon_path
	var atk_path
	var atk_weapon_path
	
	_animation_resource_visibility(index)
